# start.ps1
# Powershell automated deployment script for Wallet Descentralizada Multired

Write-Host "==========================================================" -ForegroundColor Cyan
Write-Host "  INICIANDO DEPLOY AUTOMATIZADO - WALLET DESCENTRALIZADA  " -ForegroundColor Cyan
Write-Host "==========================================================" -ForegroundColor Cyan

# 1. Check Docker service
Write-Host "[1/4] Verificando estado del motor Docker..." -ForegroundColor Yellow
...
Write-Host "[2/4] Levantando contenedores e infraestructura con Docker Compose..." -ForegroundColor Yellow
docker compose up --build -d

if ($LastExitCode -ne 0) {
    Write-Error "Fallo al ejecutar docker-compose up."
    Exit
}
Write-Host "[OK] Contenedores orquestados correctamente en segundo plano." -ForegroundColor Green

# 3. Health Checks loop
Write-Host "[3/4] Validando integridad de los servicios..." -ForegroundColor Yellow
$MaxAttempts = 15
$Attempt = 1
$webRunning = $false
$apiRunning = $false
...
if ($webRunning -and $apiRunning) {
    ...
    Write-Host "    ECOSISTEMA LEVANTADO Y VERIFICADO CORRECTAMENTE!      " -ForegroundColor Green
    Write-Host "==========================================================" -ForegroundColor Green
    ...
    Write-Host "     DEPLIEGUE FINALIZADO CON COMPROBACIONES PENDIENTES    " -ForegroundColor Red
    Write-Host "==========================================================" -ForegroundColor Red
